...
public class Utils {
	...
	public static boolean isEnnemyWorthToKill(Joueur J, boolean avantage){
		if(isEnnemyKillable(J, avantage)){
			if(avantage){
				...
				//@TODO
				//nb de tour � calculer pour �tre sur qu'on attrape le mecet si il est attrapable
				int x = 0;
	...
	/**
	 * Determine la case � aller pour fuir
	 * @param caseAFuir
	...
	//@TODO Si ca tourne en boucle et que ce n'est pas � notre avantage, essayer une nouvelle strat�gie
}
